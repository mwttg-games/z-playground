...
import io.github.mwttg.games.platform.ecs.system.DrawAnimationSystem;
...
final class MainLoop {
  ...
  private final DrawAnimationComponent component;
  ...
  MainLoop() {
    ...
    this.component = DrawAnimationComponent.create(planeData.geometry(), planeData.textureCoordinates(), textureId, timings);
  }
  ...
  void loop(final long gameWindowId) {
    while (!GLFW.glfwWindowShouldClose(gameWindowId)) {
      ...
      DrawAnimationSystem.draw(component, model, view, projection);
